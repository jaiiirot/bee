        ...
        <div>
          ...
          <div className="space-y-6 font-bold tracking-wide">
            <div className="flex items-center gap-4">
              <Icon name="map-pin" className="text-bee-yellow" size={28}/> 
              <span>La Colonia, Junín, Mendoza</span>
            </div>
            <div className="flex items-center gap-4">
              <Icon name="clock" className="text-bee-yellow" size={28}/> 
              <span>Atención: 9–13 hs | 15–17 hs</span>
            </div>
            <a href="https://wa.link/3n0uuw" target="_blank" rel="noreferrer" className="flex items-center gap-4 hover:text-bee-yellow transition">
              <Icon name="whatsapp" className="text-bee-yellow" size={28}/> 
              <span>Consultas por WhatsApp (Privado)</span>
            </a>
            <a href="https://instagram.com/_beemendoza" target="_blank" rel="noreferrer" className="flex items-center gap-4 hover:text-bee-yellow transition">
              <Icon name="instagram" className="text-bee-yellow" size={28}/> 
              <span>@_beemendoza</span>
            </a>
          </div>
        </div>

        <form className="bg-[#101010] p-8 border border-gray-800 shadow-2xl flex flex-col gap-4">
